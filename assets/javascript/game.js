...
var start = function() {
  ...
  var createWord = function() {
    ...
    for (var i = 0; i < word.length; i++) {
      ...
      letterSpots.push(underscore);
      wordSpot.appendChild(underscore);
    }
    console.log(word);   
  }
  ...
  document.addEventListener('keydown', function(event){
    ...
    for (var i = 0; i < word.length; i++) {
      if (word[i] === charTyped) {
        letterSpots[i].innerHTML = charTyped;
        var yes = true;
        rightGuess.push(i);
      } 
    }  
    ...
    if (rightGuess.length === word.length) {
      if (word === "narwhal") {
        document.getElementById("img").src = "assets/images/narwhal.jpg";
        var snd1 = new Audio("assets/sounds/whales1.wav");
        snd1.play();
      }
      if (word === "humpback") {
        document.getElementById("img").src = "assets/images/humpback.jpg";
        var snd2 = new Audio("assets/sounds/whales2.wav");
        snd2.play();
      }
      if (word === "orca") {
        document.getElementById("img").src = "assets/images/orca.jpg";
        var snd3 = new Audio("assets/sounds/whales3.wav");
        snd3.play();
      }
      if (word === "blue") {
        document.getElementById("img").src = "assets/images/blue.jpg";
        var snd4 = new Audio("assets/sounds/whales4.wav");
        snd4.play();
      }
       if (word === "beluga") {
        document.getElementById("img").src = "assets/images/beluga.jpg";;
        var snd5 = new Audio("assets/sounds/whales5.wav");
        snd5.play();
      }
       if (word === "bowhead") {
        document.getElementById("img").src = "assets/images/bowhead.jpg";
        var snd6 = new Audio("assets/sounds/whales6.wav");
        snd6.play();
      }
       if (word === "minke") {
        document.getElementById("img").src = "assets/images/minke.jpg";
